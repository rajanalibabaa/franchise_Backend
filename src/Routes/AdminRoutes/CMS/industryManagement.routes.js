...
industryManagementRouter.patch("/v1/admin/updateIndustryById",updateIndustryById)
industryManagementRouter.delete("/v1/admin/deleteIndustryById",verifyJWT,deleteIndustryById)