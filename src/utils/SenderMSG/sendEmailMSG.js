...
export const sendEmailMsg = async (
  userEmail,
  category,
  location,
  investment,
  ...
  const subject =
    matchType === "perfect"
      ? "New Incomer Investor Inquiry - Perfect Match"
      : "New Investor Matches In Investment and Location";
  ...
  for (const brand of brands) {
    ...
    try {
      ...
      console.error(
        `Error sending email to : ${brand.BrandDetails.email}`,
        error,
      );
    }
  }
