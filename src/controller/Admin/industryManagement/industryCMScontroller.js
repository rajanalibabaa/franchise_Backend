...
export const getIndustryByIndustryName = async (req, res) => {
  try {
    ...
    const categories = [...(foundIndustry.categories || [])].sort((a, b) =>
      String(a).localeCompare(String(b))
    );

    const productTags = [...(foundIndustry.productTags || [])].sort((a, b) =>
    ...
    const serviceTags = [...(foundIndustry.serviceTags || [])].sort((a, b) =>
      String(a.parent).localeCompare(String(b.parent))
    );
