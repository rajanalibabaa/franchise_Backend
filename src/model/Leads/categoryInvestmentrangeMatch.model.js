...
const categoryInvestmentrangeMatchSchema = new mongoose.Schema(
  {
    brandId: {
      type: String,
      required: true,
...
export const CategoryInvestmentrangeMatch =  mongoose.model("CategoryInvestmentrangeMatch", categoryInvestmentrangeMatchSchema);
